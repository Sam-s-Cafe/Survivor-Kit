                                ...
                                <div className="w-full sm:w-1/3 mb-4 sm:mb-0">
                                     <div className="grid grid-cols-3 gap-2">
                                        {entry.imageUrls.map((url, index) => (
                                            <img key={index} src={url} alt={`${entry.name} view ${index + 1}`} className="w-full h-20 object-cover bg-gray-700 rounded-md transition-transform duration-200 hover:scale-125 hover:z-10" />
                                        ))}
                                    </div>
                                </div>
