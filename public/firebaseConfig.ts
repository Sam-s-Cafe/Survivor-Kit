...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// THE APP WILL NOT HAVE REAL-TIME FEATURES UNTIL YOU REPLACE THESE PLACEHOLDERS
...
service cloud.firestore {
  match /databases/{database}/documents {
    ...
    match /messages/{document=**} {
      allow read, create: if request.auth != null && request.auth.uid == request.resource.data.senderId;
      allow update, delete: if false;
    }
    // Allows any authenticated user to read/write bunkers, but not delete.
    match /bunkers/{document=**} {
      allow read, create: if request.auth != null && request.auth.uid == request.resource.data.creatorId;
      allow update, delete: if false;
    }
  }
}
